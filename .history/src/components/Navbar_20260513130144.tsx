      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2 group">
            <div className="w-9 h-9 rounded-full bg-[#C0392B] flex items-center justify-center text-white font-bold text-sm shadow-md group-hover:scale-110 transition-transform">
              <img
                src="D:\DATA1 ( belum selesai )\c\MAS IKLIL\Mew work\kantin-larasati\public\images\logo-larasati.jpg"
                alt="Logo"
            ...
            <div className="leading-none">
              <div
                className="text-[#F5EDD6] font-bold text-base"
                style={{ fontFamily: 'Playfair Display, serif' }}
              >
                Kantin Larasati
              </div>
              <div className="text-[#F0A500] text-[10px] font-medium" style={{ fontFamily: 'Caveat, cursive' }}>
                Sejak 2023 · Jogja
              </div>
            </div>
          </a>
